...
namespace Peasy.Synchronous
{
    ...
    /// </summary>
    public interface ISynchronousCommandValidationResult
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether the validation result will allow continuation of command execution via <see cref="CompleteCommandExecution"/>.
        /// </summary>
