...
namespace Facile
{
    ...
    //    public virtual IReturnsObjectCommand<T> GetByIDCommand(int id)
    //    {
    //        return new ReturnsObjectServiceCommand<T>
    //        (
    //            executeMethod: () => GetByID(id),
    //            executeAsyncMethod: () => GetByIDAsync(id),
    //            getValidationResultsMethod: () => GetValidationResultsForGetByID(id),
    ...
    //    public virtual IReturnsIEnumerableCommand<T> GetAllCommand()
    //    {
    //        return new ReturnsIEnumerableServiceCommand<T>
    //        (
    //            executeMethod: () => GetAll(),
    //            executeAsyncMethod: () => GetAllAsync(),
    //            getValidationResultsMethod: () => GetValidationResultsForGetAll(),
    ...
    //    public virtual IReturnsObjectCommand<T> InsertCommand(T entity)
    //    {
    //        return new ReturnsObjectServiceCommand<T>
    //        (
    //            executeMethod: () => Insert(entity),
    ...
    //    public virtual IReturnsObjectCommand<T> UpdateCommand(T entity)
    //    {
    //        return new ReturnsObjectServiceCommand<T>
    //        (
    //            executeMethod: () => Update(entity),
    ...
    //    public virtual IReturnsVoidCommand DeleteCommand(int id)
    //    {
    //        return new ReturnsVoidServiceCommand
    //        (
    //            executeMethod: () => Delete(id),
    //            executeAsyncMethod: () => DeleteAsync(id),
    //            getValidationResultsMethod: () => GetValidationResultsForDelete(id),
